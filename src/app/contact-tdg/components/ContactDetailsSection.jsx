          ...
          <div className="flex flex-col justify-center space-y-5">
            ...
            <div className="bg-white p-6 sm:p-8 border border-gray-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#0356C2] hover:bg-[#0248A0] active:bg-[#023a7d] text-white font-semibold py-3.5 px-6 rounded-lg transition-all duration-200 text-base shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#0356C2] focus:ring-offset-2 flex items-center justify-center gap-2"
                >
