        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {otherLocations.map((location) => (
            <button
              ...
              type="button"
              onClick={() => handleSelect(location)}
              className="group relative overflow-hidden text-left w-full bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-200 hover:border-[#0356C2] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#0356C2] focus:ring-offset-2 transform hover:-translate-y-1"
            >
