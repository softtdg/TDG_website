      ...
      <div className="max-w-8xl mx-auto flex flex-col md:flex-row md:justify-between md:items-start gap-6 sm:gap-8 md:gap-12 lg:gap-0 max-w-[1905px]">
        ...
        <div className="flex flex-col md:items-center md:gap-6 z-10">
          ...
          <div className="mt-3 sm:mt-4 md:mt-6 lg:mt-0">
            <button
              type="button"
              className="cursor-pointer inline-flex font-semibold items-center gap-2 border-2 border-[#161C25] text-[#161C25] text-[16px] sm:text-[18px] md:text-[19px] lg:text-[20px] rounded-full px-[8px] sm:px-[10px] py-[8px] sm:py-[10px] hover:bg-gray-100 focus:outline-none"
            >
              <img
        ...
        {/* Links */}
        <div className="flex flex-col sm:flex-row sm:gap-20 md:gap-32 lg:gap-50 text-sm text-gray-900 z-10">
